...
export default function BookTableForm() {
  ...
  const handleSubmit = (event) => {
    ...
    axios.post('http://127.0.0.1:8000/booktable/', formData)
      .then((response) => {
        console.log(response.data);
        // reset form data after submitting 
        setFormData({ first_name: '', last_name: '', email: '', phone: '', date: '', time: '', number: '', message: '' });
      })
      .catch((error) => {
        console.log(error);
      });
            ...
            <div className="w-full h-auto bg-gray-400 hidden lg:block lg:w-5/12 bg-cover rounded-l-lg"
              Style="background-image: url('/public/img/book/table.jpg')">
					  ...
					  <div className="w-full lg:w-7/12 bg-white p-5 rounded-lg lg:rounded-l-none">
						<h3 className="pt-4 text-2xl text-center text-orange-600">Book Your Stay With Us!</h3>
